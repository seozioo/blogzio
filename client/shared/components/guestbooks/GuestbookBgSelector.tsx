  ...
  const renderRadioOption = (color: GuestbookMessageBgColor) => (
    <Radio.Root
      ...
      className={guestbookMessageBgColorVariants({
        className:
          'flex size-6 items-center justify-center rounded-lg border border-border inset-ring-0 inset-ring-white hover:inset-ring-4 data-checked:to-white data-checked:from-white transition-all focus-visible:ring-2 focus-visible:ring-sky-400/20 outline-none active:translate-y-px data-checked:-translate-y-0.5',
